...
void loop() {
  ...
  if (Serial.available() >0) {
    ...
    switch (s) {
      ...
      if ((s>90 && s<210) || (s>240 && s!=340 && s!=400)) {
        s=-1;
      }
...
void irsPinAEn0(){
  ...
  if (digitalRead(Enc[0].pinA) == HIGH) { /* low->high on A? */
      
    if (digitalRead(Enc[0].pinB) == LOW) {  /* check pin B   */
  	Enc[0].pos = Enc[0].pos + 1;      /* going clockwise */
    } else {
  	Enc[0].pos = Enc[0].pos - 1;     /* counterclockwise */
    }
    
  } else {                       /* must be high to low on A */
  
    if (digitalRead(Enc[0].pinB) == HIGH) {   /* check pin B */
  	Enc[0].pos = Enc[0].pos + 1;      /* going clockwise */
    } else {
  	Enc[0].pos = Enc[0].pos - 1;     /* counterclockwise */
    }
...
void isrPinBEn0(){ 
  ...
  /* this updates the counter                                */
  if (digitalRead(Enc[0].pinB) == HIGH) { /* low->high on B? */
  
    if (digitalRead(Enc[0].pinA) == HIGH) {   /* check pin A */
  	Enc[0].pos = Enc[0].pos + 1;      /* going clockwise */
    } else {
  	Enc[0].pos = Enc[0].pos - 1;     /* counterclockwise */
    }
    ...
    if (digitalRead(Enc[0].pinA) == LOW) {    /* check pin A */
  	Enc[0].pos = Enc[0].pos + 1;      /* going clockwise */
    } else {
  	Enc[0].pos = Enc[0].pos - 1;     /* counterclockwise */
    }
...
void irsPinAEn1(){
  ...
  /* this updates the counter                                */
  if (digitalRead(Enc[1].pinA) == HIGH) { /* low->high on A? */
      
    if (digitalRead(Enc[1].pinB) == LOW) {    /* check pin B */
  	Enc[1].pos = Enc[1].pos + 1;      /* going clockwise */
    } else {
  	Enc[1].pos = Enc[1].pos - 1;     /* counterclockwise */
    }
    
  } else { /* must be high to low on A                       */
  
    if (digitalRead(Enc[1].pinB) == HIGH) {   /* check pin B */
  	Enc[1].pos = Enc[1].pos + 1;      /* going clockwise */
    } else {
  	Enc[1].pos = Enc[1].pos - 1;     /* counterclockwise */
    }
...
void isrPinBEn1(){ 
  ...
  /* this updates the counter                                */
  if (digitalRead(Enc[1].pinB) == HIGH) { /* low->high on B? */
  
    if (digitalRead(Enc[1].pinA) == HIGH) {   /* check pin A */
  	Enc[1].pos = Enc[1].pos + 1;      /* going clockwise */
    } else {
  	Enc[1].pos = Enc[1].pos - 1;     /* counterclockwise */
    }
    ...
    if (digitalRead(Enc[1].pinA) == LOW) {    /* check pin A */
  	Enc[1].pos = Enc[1].pos + 1;      /* going clockwise */
    } else {
  	Enc[1].pos = Enc[1].pos - 1;     /* counterclockwise */
    }
...
void irsPinAEn2(){
  ...
  /* this updates the counter                                */
  if (digitalRead(Enc[2].pinA) == HIGH) { /* low->high on A? */
      
    if (digitalRead(Enc[2].pinB) == LOW) {    /* check pin B */
  	Enc[2].pos = Enc[2].pos + 1;      /* going clockwise */
    } else {
  	Enc[2].pos = Enc[2].pos - 1;     /* counterclockwise */
    }
    
  } else { /* must be high to low on A                       */
  
    if (digitalRead(Enc[2].pinB) == HIGH) {   /* check pin B */
  	Enc[2].pos = Enc[2].pos + 1;      /* going clockwise */
    } else {
  	Enc[2].pos = Enc[2].pos - 1;     /* counterclockwise */
    }
...
void isrPinBEn2(){ 
  ...
  /* this updates the counter                                */
  if (digitalRead(Enc[2].pinB) == HIGH) { /* low->high on B? */
  
    if (digitalRead(Enc[2].pinA) == HIGH) {   /* check pin A */
  	Enc[2].pos = Enc[2].pos + 1;      /* going clockwise */
    } else {
  	Enc[2].pos = Enc[2].pos - 1;     /* counterclockwise */
    }
    ...
    if (digitalRead(Enc[2].pinA) == LOW) {    /* check pin A */
  	Enc[2].pos = Enc[2].pos + 1;      /* going clockwise */
    } else {
  	Enc[2].pos = Enc[2].pos - 1;     /* counterclockwise */
    }
